...
// Strictly require staff or admin authentication
...
<body>
    ...
    <header class="navbar">
        <div class="nav-brand">
            ...
            <div class="brand-text">
                ...
                <p>Sate Tulang Madu Kitchen Ops</p>
            </div>
        </div>
        ...
        <div class="nav-actions" style="display:flex; align-items:center; gap:0.75rem;">
            ...
            <div style="display:flex; align-items:center; gap:6px; font-size:0.82rem; color:var(--text-muted); background:var(--bg-card); padding:4px 10px; border-radius:var(--radius-full); border:1px solid var(--border-color);">
                <span><?php echo htmlspecialchars($currentUser['full_name'] ?? 'Staff'); ?></span>
                <span class="badge <?php echo ($currentUser['role'] === 'admin') ? 'badge-primary' : 'badge-gold'; ?>" style="font-size:0.65rem; padding:1px 5px;">
                    <?php echo strtoupper($currentUser['role'] ?? 'STAFF'); ?>
                </span>
            </div>
    ...
    <main class="container-fluid">
        ...
        <section id="view-kds">
            <!-- Grill Stick Aggregator Bar -->
            <div class="kds-header">
                <div class="grill-aggregator-bar" id="grill-aggregator-content">
                    <span style="color:var(--text-muted);">Loading grill queue counters...</span>
                </div>

                <div style="display:flex; align-items:center; gap:0.75rem;">
                    <div style="font-size:0.85rem; color:var(--text-muted);">
                        Active Orders: <span class="badge badge-primary" id="active-orders-count">0</span>
                    </div>

                    <!-- KDS Filter Tabs -->
                    <div style="display:flex; gap:4px; background:var(--bg-card); padding:4px; border-radius:var(--radius-full); border:1px solid var(--border-color);">
                        <button class="kds-filter-pill btn btn-sm btn-secondary active" data-filter="all" style="border-radius:var(--radius-full);">All</button>
                        <button class="kds-filter-pill btn btn-sm btn-secondary" data-filter="dine_in" style="border-radius:var(--radius-full);">Dine-In</button>
                        <button class="kds-filter-pill btn btn-sm btn-secondary" data-filter="takeaway" style="border-radius:var(--radius-full);">Takeaway</button>
                        <button class="kds-filter-pill btn btn-sm btn-secondary" data-filter="delivery" style="border-radius:var(--radius-full);">Delivery</button>
                    </div>
                </div>
            </div>
